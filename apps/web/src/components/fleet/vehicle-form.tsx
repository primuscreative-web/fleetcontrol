...
import { createVehicle, getFleetOptions, type VehiclePayload } from "@/lib/fleet";
  ...
  return (
    <AccessGuard permission={permissions.fleet.manage}>
      <form className="space-y-6" onSubmit={form.handleSubmit((values) => mutation.mutate(values))}>
        <Breadcrumb items={[{ label: "Frota", href: "/dashboard/frota" }, { label: "Novo" }]} />
        <section className="flex flex-col gap-2">
          <h1 className="text-2xl font-semibold tracking-normal">Novo veiculo</h1>
